...
\Contributors{Esra Bulbul, Johann Cohen-Tanugi, Alessandro Cuoco, Alex Drlica-Wagner, Shunsaku Horiuchi, Manuel Meyer, Andrew Pace, Ethan Nadler, Eric Nuss, Gabrijela Zaharijas}
...
\label{sec:dwarfs_id}
\Contributors{Andrew Pace, Alex Drlica-Wagner, Ethan Nadler, Manuel Meyer}

\begin{figure}[t]
\centering
\includegraphics[width=0.75\columnwidth]{annih_limits.pdf}
\caption{Constraints on dark matter annihilation to $b\bar{b}$ from {\it Fermi-LAT} observations of Milky Way satellite galaxies \citep[LAT Dwarfs;][]{} and HESS observations of the Galactic Center \citep[HESS GC;][]{1607.08142}. 
