...
These facilities can be broadly divided into two categories: wide-field, massively multiplexed spectroscopy on medium- to large-aperture telescopes ($\roughly 8-10$-meter class); and giant segmented mirror telescopes (GSMTs, $\roughly 30$-meter class) with relatively smaller fields of view. 
