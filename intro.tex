...
\hline 
\hline
Warm Dark Matter (WDM) & Halo Mass & Particle Mass & \FIXME{$m_{\rm WDM} \sim 17 \keV$} \\
Self-Interacting Dark Matter (SIDM) & Halo Profile & Cross Section & \FIXME{$\sigma/m \sim 0.1\text{--}10\cm^2/\g$} \\
...
Primordial Black Holes (PBHs) & Compact Objects & Mass & \FIXME{$M \sim 10^{-12}\text{--}10^{7} \Msun$} \\
