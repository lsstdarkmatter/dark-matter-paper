...
\hline 
\hline
Warm Dark Matter (WDM) & Halo Mass & Particle Mass & \CHECK{$m_{\rm WDM} \sim 25 \keV$} \\
Self-Interacting Dark Matter (SIDM) & Halo Profile & Cross Section & \CHECK{$\sigma/m \sim 0.1\text{--}10\cm^2/\g$} \\
Baryon-Scattering Dark Matter (BSDM) & Halo Mass & Cross Section & \CHECK{$\sigma \sim 10^{-30} \cm^2$} \\
