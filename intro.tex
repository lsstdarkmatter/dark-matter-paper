...
\AHGP{Alex, check my rewrite to see if I captured the essence of what you meant}
...
\enddata
\tablecomments{\ADW{There are clearly a lot of caveats on each line, but I think that a table like this would be very useful. I could use help here!}\AHGP{I concur.}}
\end{deluxetable*}
