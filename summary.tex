\begin{comment}
{\bf Abstract:}
This white paper summarizes the results of a community effort to assemble the science case for understanding the fundamental physics of dark matter with the Large Synoptic Survey Telescope (LSST). Astrophysical observations are currently the only robust, empirical measurements of dark matter, and future observations with LSST will provide necessary guidance for the rest of the experimental dark matter program. In this document, we discuss how LSST will inform our understanding of the fundamental properties of dark matter, such as dark matter particle mass, dark matter self-interaction cross section, compact macroscopic dark matter, and axion-like particles. Additionally, we discuss the ways that LSST will complement other dark matter programs to strengthen our understanding of the fundamental characteristics of dark matter. More information on the LSST dark matter effort can be found at \href{this url}{}
\end{comment}
