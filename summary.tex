...
This white paper summarizes a community effort to assemble the science case for studying the fundamental physics of dark matter with the Large Synoptic Survey Telescope (LSST). Astrophysical and cosmological observations currently provide the only robust, empirical measurements of dark matter, and future observations with LSST will provide necessary guidance for the rest of the experimental dark matter program. In this document, we discuss how LSST will inform our understanding of the fundamental properties of dark matter, such as dark matter particle mass, dark matter scattering cross sections, compact macroscopic dark matter, and non-gravitational couplings to the Standard Model. Additionally, we discuss the ways that LSST will complement other experiments to strengthen our understanding of the fundamental characteristics of dark matter. More information on the LSST dark matter effort can be found at \href{this url}{https://lsstdarkmatter.github.io/}.
\clearpage
\end{comment}
