...
\Contributors{Hai-Bo Yu, Matthew Buckley, Vera Gluscevic, Kimberly K.\ Boddy, Francis-Yan Cyr-Racine, Annika H.\ G.\ Peter, Manoj Kaplinghat, Alex Drlica-Wagner}
...
Assuming the Planck 2016 cosmology \citep{Ade:2015xua}, the half-mode halo mass, \Mhm, is related to the WDM thermal relic particle mass, \mWDM, by \citep[\eg][]{schneider2012,Nadler:2019}
\begin{equation} \label{eqn:Mhm}
    M_{\rm hm} = 1.6 \times 10^{10} \left( \frac{\mWDM}{1 {\rm keV}} \right)^{-3.33} \Msun.
\end{equation}
...
\begin{equation} \label{eqn:mWDM}
    \mWDM =  2.3 \left(\frac{M_{hm}}{10^{9} {\rm M_\odot}} \right)^{-0.3} \keV.
\end{equation}
...
Measurements of the Lyman-$\alpha$ forest \citep[\eg][]{Viel:2013,2017PhRvD..96b3522I} and ultra-faint satellite galaxies \citep[\eg][]{Jethwa:2018,Kim:2017iwr} place lower bounds on the mass of thermally produced WDM particles at $\roughly 2$--$5\keV$, corresponding to a halo mass scale of $\roughly 10^8-10^9 \Msun$.
...
Exchange of the gauge boson (a ``dark photon'') then mediates self-interactions, analogous to Rutherford scattering. A phenomenologically similar model replaces the vector mediator with a light scalar. The interaction Lagrangian is then described by %\citep{Tulin:2012wi,Tulin:2013teo}:
\begin{equation}
\label{eq:sidm}
{\cal L_{\rm int}}=\bigg\{
\begin{array}{c l}
...
\subsection{Baryon-Scattering Dark Matter}
