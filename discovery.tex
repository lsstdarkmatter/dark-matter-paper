...
\NEW{
In \figref{macho_discovery}, we present a cartoon illustrating the discovery of a high-mass PBH population. 
We simulate the underlying population of astrophysically produced microlensing events in a $0.34\deg^2$ bulge field according to {\bf \textcolor{red}{help here Casey...}}. 
The astrophysical black hole population was created assuming a solar metallicity progenitor population without a significant binary fraction. 
We then scale these rates to a $10\degrees \times 10\degrees$ Galactic bulge field that could be observed as part of a devoted LSST mini-survey.
 We model the effects of a significant PBH population by randomly re-injecting a subsample of the astrophysical black hole population ($f = {5\%,15\%,30\%}$) after increasing each black hole mass by an order of magnitude.
Astrometric microlensing described in \secref{complement} will be important for breaking the mass-distance degeneracy of the lens.
}
n
\begin{figure}[t]
\centering
