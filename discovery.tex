...
The number of detectable microlensing events will subject to the LSST microlensing detection efficiency, which is expected to be $\gtrsim 1\%$ for events with $t_{\rm E} > 100$\,days.
