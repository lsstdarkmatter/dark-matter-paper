...
\caption{\label{fig:macho_constraints}
    ...
    \NEW{The projected LSST sensitivity does not include contamination from conventional astrophysical microlensing events.}
}
\end{figure}
...
If scheduled optimally, the wide field-of-view, high cadence, and precise photometry of LSST \NEW{will provide sensitivity to microlensing event rates corresponding to $\roughly 0.03\%$ of the dark matter density in compact objects with} masses $>0.1\Msun$ (\figref{macho_constraints}).
...
\NEW{These sensitivity projection do not attempt to separate microlensing events produced by PBHs from conventional microlensing events produced by stars and compact objects resulting from stellar evolution. 
