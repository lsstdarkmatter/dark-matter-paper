...
\NEW{These sensitivity projection do not include contamination from microlensing events caused by stars and compact objects resulting from stellar evolution. They are thus an estimate of the limiting sensitivity of LSST in a ``background free'' regime (see \secref{pbh_discovery} for more details on expected conventional microlensing event rates).}
