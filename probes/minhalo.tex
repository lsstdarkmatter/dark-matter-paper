...
\rho_0=\rho_s f(t/t_0)\,
\end{equation}
where $t_0 = a(\sigma/m)\rho_s v_0$ with $v_0^2=4\pi G \rho_s r_s^2$ and $a=\sqrt{16/\pi}$ for a hard-sphere interaction~\citep{Balberg:2002ue}. The function $f$ encodes the evolution of the core density with time in the presence of self-interactions. It depends on the orbital history such that highly stripped halos will evolve faster for the same $\rho_s$ and $r_s$, the NFW density and radial scale parameters~\citep{Nishikawa:2019lsc}.
