...
\ADW{Add a few words about power spectra analyses?}\AHGP{Yes, I concur that it would be useful.}

\textbf{Although analyzing individual stream gap density gives us vital information of the likely perturber, studying the one-dimensional stream density and track power spectra allows us to be sensitive to the subhalo mass function. This is because a stellar stream encounters several subhalos over its dynamical age each of which leaves an imprint on the stream density and track. Higher mass subhalos affects larger part of the stream thereby producing power only on large scales, while lower mass subhalos cause density power at small scales. By statistically analyzing the stream density power spectrum \citep{bovy:2017, 2018JCAP...07..061B} showed that we can constrain the properties of dark matter. LSST’s high quality data will allow us to measure the stream density as well as track power at small angular scales that were previously dominated by noise. This will make the power spectrum method sensitive to subhalos down to mass $10^5$ $M_\odot$. In addition, precise measurement of density and track of multiple streams will allow us to combine their statistics and put tighter constraints on the properties of dark matter. }
