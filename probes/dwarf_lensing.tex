...
In particular, the ``core-cusp'' problem in dwarf galaxies has been cited as one of the most significant challenges to CDM \citep[\eg,][]{2010AdAst2010E...5D,Bullock:2017}.
...
A self-interaction cross-section of $\sigma / m_\chi \sim 1 \cmg$ can explain the diversity of rotation curves seen in low-mass spiral galaxies \citep[\eg,][]{1504.01437,Kamada:2016euw,Tulin:2017ara}.
...
However, one key prediction is that the creation of cores will be sensitive to the exact star formation history \citep[\eg,][]{governato2012,dicintio2014,onorbe2015,Read:2016,1811.11768,2019MNRAS.tmp....3R}.
