...
However, to statistically distinguish the different profiles, one needs to measure the shear at very small angular scales ($< 10\kpc$), which is the regime where PSF systematics dominate. 
In other words, the numbers of source and lens galaxies that LSST can find will be high enough to distinguish the difference between the two profiles provided ideal shape measurement. 
